...
public class LoginActivity extends AppCompatActivity {
    WebView webView;
    private String webUrl = "https://melbetapps.com/";
    ...
    public void onBackPressed() {
        if (webView.canGoBack()) {
            ...
            AlertDialog.Builder bb=new AlertDialog.Builder(LoginActivity.this);
            bb.setTitle("Warning")
                    .setMessage("Are you want to exit from our apps?")
                    .setCancelable(false)
